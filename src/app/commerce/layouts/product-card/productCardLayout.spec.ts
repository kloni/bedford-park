...
import { ProductCardLayoutComponent } from './productCardLayout';
...
describe('ProductCardLayoutComponent', () => {
	let component:ProductCardLayoutComponent;
	let fixture:ComponentFixture<ProductCardLayoutComponent>;
	let httpMock:HttpTestingController;

	beforeEach(async(() => {
		// use mock service for dependency
		TestBed.configureTestingModule({
			declarations: [ ProductCardLayoutComponent ],
	...
	beforeEach((done)=>{
		...
		fixture = TestBed.createComponent(ProductCardLayoutComponent);
