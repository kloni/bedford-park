...
export class LoginIdentityService extends TransactionService {
    ...
    login(parameters: any, headers ? : any, url ? : string): Observable < HttpResponse < any >> {
        ...
        if (this.getStorefrontUtils().useMocks || useMocks) {
            ...
            requestUrl = 'mocks/commerce/transaction' + path + fileNameSeparator + testGroup + '.login.mocks.json';
        }
        let form = {};
        let body = {};
        ...
        if (parameters['generateLTPAToken'] !== undefined) {
            queryParameters = serviceUtils.setQueryParam(queryParameters, 'generateLTPAToken', parameters['generateLTPAToken']);
        }
    ...
    logout(parameters: any, headers ? : any, url ? : string): Observable < HttpResponse < any >> {
        ...
        if (this.getStorefrontUtils().useMocks || useMocks) {
            ...
            let fileNameSeparator = testGroup === "" ? "" : ".";
            requestUrl = 'mocks/commerce/transaction' + path + fileNameSeparator + testGroup + '.logout.mocks.json';
        }
        let form = {};
        let body = {};
        let header: HttpHeaders;
