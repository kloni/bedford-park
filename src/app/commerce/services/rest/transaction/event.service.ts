...
export class EventService extends TransactionService {
     ...
     */
    handleClickInfo(parameters: any, headers ? : any, url ? : string): Observable < HttpResponse < any >> {
        let useMocks = false;
        ...
        let path = '/store/{storeId}/event/click_info';
        ...
        if (this.getStorefrontUtils().useMocks || useMocks) {
            ...
            requestUrl = 'mocks/commerce/transaction' + path + fileNameSeparator + testGroup + '.handleClickInfo.mocks.json';
        }
        let form = {};
        let body = {};
        ...
        if (parameters['storeId'] === undefined) {
            throw new Error("Request '/store/{storeId}/event/click_info' missing required parameter storeId");
        }
     ...
     */
    triggerMarketing(parameters: any, headers ? : any, url ? : string): Observable < HttpResponse < any >> {
        let useMocks = false;
        //Set domain based on profile.
        if (url && url === 'mocks') {
            url = undefined;
        ...
        if (this.getStorefrontUtils().useMocks || useMocks) {
            ...
            let fileNameSeparator = testGroup === "" ? "" : ".";
            requestUrl = 'mocks/commerce/transaction' + path + fileNameSeparator + testGroup + '.triggerMarketing.mocks.json';
        }
        let form = {};
        let body = {};
        let header: HttpHeaders;
        ...
        if (parameters['storeId'] === undefined) {
            throw new Error("Request '/store/{storeId}/event' missing required parameter storeId");
        }
