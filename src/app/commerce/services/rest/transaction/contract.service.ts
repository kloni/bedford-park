...
export class ContractService extends TransactionService {
     ...
     */
    findEligible(parameters: any, headers ? : any, url ? : string): Observable < HttpResponse < any >> {
        let useMocks = false;
        ...
        let path = '/store/{storeId}/contract';
        ...
        if (this.getStorefrontUtils().useMocks || useMocks) {
            ...
            requestUrl = 'mocks/commerce/transaction' + path + fileNameSeparator + testGroup + '.findEligible.mocks.json';
        }
        let form = {};
        let body = {};
        ...
        if (parameters['storeId'] === undefined) {
            throw new Error("Request '/store/{storeId}/contract' missing required parameter storeId");
        }

        queryParameters = queryParameters.set('q', 'eligible');

        if (parameters['q'] === undefined) {
            throw new Error("Request '/store/{storeId}/contract' missing required parameter q");
        }
