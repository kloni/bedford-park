...
export class AssignedPromotionCodeService extends TransactionService {
    ...
    getAssignedPromotioncodeInfo(parameters: any, headers ? : any, url ? : string): Observable < HttpResponse < any >> {
        ...
        if (this.getStorefrontUtils().useMocks || useMocks) {
            ...
            requestUrl = 'mocks/commerce/transaction' + path + fileNameSeparator + testGroup + '.getAssignedPromotioncodeInfo.mocks.json';
        }
        let form = {};
        let body = {};
    ...
    applyPromotioncode(parameters: any, headers ? : any, url ? : string): Observable < HttpResponse < any >> {
        ...
        if (this.getStorefrontUtils().useMocks || useMocks) {
            ...
            let fileNameSeparator = testGroup === "" ? "" : ".";
            requestUrl = 'mocks/commerce/transaction' + path + fileNameSeparator + testGroup + '.applyPromotioncode.mocks.json';
        }
        let form = {};
        let body = {};
        let header: HttpHeaders;
    ...
    removePromotionCode(parameters: any, headers ? : any, url ? : string): Observable < HttpResponse < any >> {
        ...
        if (this.getStorefrontUtils().useMocks || useMocks) {
            ...
            let fileNameSeparator = testGroup === "" ? "" : ".";
            requestUrl = 'mocks/commerce/transaction' + path + fileNameSeparator + testGroup + '.removePromotionCode.mocks.json';
        }
        let form = {};
        let body = {};
        let header: HttpHeaders;
