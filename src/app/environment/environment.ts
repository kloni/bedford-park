...
export const environment = {
  ...
  apiUrl: new URL(`${window.location.protocol}//${window.location.hostname}:${window.location.port}/api${baseUrl}`),
  deliveryUrl: new URL(`${window.location.protocol}//${window.location.hostname}:${window.location.port}${baseUrl}`),
    httpOptions: {
    pollTime: 999999,
    retries: 5,
